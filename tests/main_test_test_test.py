...
def test_main_does_not_execute_on_import():
    ...
    with patch("src.organizer.organize_folder") as mock_organize, \
        ...
        module = __import__("scripts.folder-organizer.main", fromlist=["*"])
        # Ensure that the guard prevented execution
        mock_organize.assert_not_called()
        mock_display.assert_not_called()
        mock_print.assert_not_called()
        # The module should expose a __name__ attribute not equal to '__main__'
